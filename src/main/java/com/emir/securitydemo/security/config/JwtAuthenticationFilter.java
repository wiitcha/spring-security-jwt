package com.emir.securitydemo.security.config;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (!StringUtils.isEmpty(extractedUsername)) {
            UserDetails userDetails = this.employeeDetailsService.loadUserByUsername(extractedUsername);
